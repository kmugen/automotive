...
{
    {
        ...
        timerConfig.base.isrPriority                = 200;
        ...
        coutx[0] = &IfxGtm_TOM0_9_TOUT1_P02_1_OUT;
        ccx[0] = &IfxGtm_TOM0_4_TOUT22_P33_0_OUT;
        coutx[1] = &IfxGtm_TOM0_3_TOUT105_P10_3_OUT;
...
void GtmTomPwmHl_init(void)
{
    ...
    IfxGtm_Cmu_setClkFrequency(&MODULE_GTM, IfxGtm_Cmu_Clk_0, TRUE);
